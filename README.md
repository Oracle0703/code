...
> 当前状态：`v0.1` 基础框架与 SQLite 数据底座。Electron 进程隔离、真实浏览器、真实终端、可迁移数据库和安全备份链路已经打通，下一步接入真实工作区与个人事务数据。
...
- 受控手动备份 API，以及 Linux/Windows 打包后 SQLite 建库、迁移、备份和重开验证
